...
ask_block_hosts() {
    ...
    case $block_choice in
        [Yy]* )
            echo ""
            sudo sed -i '' '/# MDM Servers/d' /Volumes/macOS/etc/hosts
            sudo sed -i '' '/# End/d' /Volumes/macOS/etc/hosts
            sudo sed -i '' '/deviceenrollment.apple.com/d' /Volumes/macOS/etc/hosts
            sudo sed -i '' '/mdmenrollment.apple.com/d' /Volumes/macOS/etc/hosts
            sudo sed -i '' '/iprofiles.apple.com/d' /Volumes/macOS/etc/hosts
            sudo sed -i '' '/acmdm.apple.com/d' /Volumes/macOS/etc/hosts
            sudo sed -i '' '/axm-adm-mdm.apple.com/d' /Volumes/macOS/etc/hosts

            echo "# MDM Servers" | sudo tee -a /Volumes/macOS/etc/hosts
            echo "0.0.0.0 deviceenrollment.apple.com" | sudo tee -a /Volumes/macOS/etc/hosts
            echo "0.0.0.0 mdmenrollment.apple.com" | sudo tee -a /Volumes/macOS/etc/hosts
            echo "0.0.0.0 iprofiles.apple.com" | sudo tee -a /Volumes/macOS/etc/hosts
            echo "0.0.0.0 acmdm.apple.com" | sudo tee -a /Volumes/macOS/etc/hosts
            echo "0.0.0.0 axm-adm-mdm.apple.com" | sudo tee -a /Volumes/macOS/etc/hosts
            echo "# End" | sudo tee -a /Volumes/macOS/etc/hosts
...
ask_block_hosts_recovery() {
    ...
    case $block_recovery_choice in
        [Yy]* )
            echo ""
            sed -i '' '/# MDM Servers/d' /Volumes/macOS/etc/hosts
            sed -i '' '/# End/d' /Volumes/macOS/etc/hosts
            sed -i '' '/deviceenrollment.apple.com/d' /Volumes/macOS/etc/hosts
            sed -i '' '/mdmenrollment.apple.com/d' /Volumes/macOS/etc/hosts
            sed -i '' '/iprofiles.apple.com/d' /Volumes/macOS/etc/hosts
            ...
            echo "0.0.0.0 acmdm.apple.com" >> /Volumes/macOS/etc/hosts
            echo "0.0.0.0 axm-adm-mdm.apple.com" >> /Volumes/macOS/etc/hosts
            echo "# End" >> /Volumes/macOS/etc/hosts
